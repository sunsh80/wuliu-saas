...
- `PUT /api/tenant-web/orders/{order_id}/claim` - 认领订单
- `PUT /api/tenant-web/orders/{order_id}/complete` - 完成订单

### 客户API (需认证)
- `POST /api/customer/orders` - 创建客户订单
- `GET /api/customer/orders` - 获取客户订单列表
- `GET /api/customer/orders/{order_id}` - 获取订单详情
- `PUT /api/customer/orders/{order_id}` - 更新订单
- `DELETE /api/customer/orders/{order_id}` - 删除订单
- `GET /api/customer/orders/{order_id}/quotes` - 获取订单报价
- `POST /api/customer/orders/{order_id}/award` - 选择承运商
...
- `PUT /api/carrier/orders/{order_id}/claim` - 认领订单
- `PUT /api/carrier/orders/{order_id}/complete` - 完成订单
- `POST /api/carrier/orders/{order_id}/quote` - 提交报价
- `PUT /api/carrier/orders/{order_id}/start-delivery` - 开始配送
