...
export const pricingApi = {
  // 获取平台定价规则
  getPlatformPricingRules: () => {
    return apiClient.get('/platform/pricing-rules');
  },

  // 更新平台定价规则
  updatePlatformPricingRules: (data) => {
    return apiClient.put('/platform/pricing-rules', data);
  },
  ...
  // 获取时间规则
  getTimeRules: () => {
    return apiClient.get('/time-rules');
  },

  // 更新时间规则
  updateTimeRules: (data) => {
    return apiClient.put('/time-rules', data);
  },
