    ...
    try {
      ...
      if (profileResponse.ok) {
        ...
        if (profileData.success && profileData.data) {
          ...
          if (welcomeMessageEl) {
            welcomeMessageEl.textContent = `欢迎，${profileData.data.name || profileData.data.username || '承运商'}`;
          }
        }
      }
      ...
      if (ordersResponse.ok) {
        ...
        if (ordersData.success && ordersData.data) {
          ...
          const inTransitOrdersEl = document.getElementById('inTransitOrders');
          const completedOrdersEl = document.getElementById('completedOrders');
          
          if (pendingOrdersEl) pendingOrdersEl.textContent = pending;
          if (inTransitOrdersEl) inTransitOrdersEl.textContent = inTransit;
