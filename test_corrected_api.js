...
async function testVehicleModelsAPI() {
  console.log('🔍 测试 /api/tenant-web/vehicles/available-models API...');
  ...
  try {
    ...
    // 调用车型API
    console.log('🚚 获取车型列表...');
    const response = await axios.get('http://localhost:3000/api/tenant-web/vehicles/available-models', {
      headers: {
